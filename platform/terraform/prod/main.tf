...
module "ecs_api" {
  ...
  api_image    = "${var.ecr_api_registory}/${var.ecr_api_repository}:${local.api_image_tag}"
...
module "ecs_migration" {
  ...
  migration_image         = "${var.ecr_api_registory}/${var.ecr_migration_repository}:${local.migration_image_tag}"
  image_tag               = local.migration_image_tag
}
