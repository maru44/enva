...
build/cli:
	...
	@GOOS=${GOOS_DARWIN} GOARCH=${GOARCH_AMD} go build -o ${BIN_DIR}enva/${GOOS_DARWIN}/${GOARCH_AMD}/${BIN_NAME} \
		-ldflags '-X github.com/maru44/enva/enva/commands.apiUrl=${CLI_API_URL} -X github.com/maru44/enva/enva/commands.frontUrl=${FRONT_PROTOCOL}${FRONT_HOST}${FRONT_PORT}' ${ENVA_MAIN_FILE}
