...
SETTINGS_FILE_NAME:=enva.json
ifeq (${ENVIRONMENT}, development)
  BIN_NAME=enva_dev
  TAR_DIR=${BIN_DIR}enva/
  SETTINGS_FILE_NAME=enva_dev.json
endif
...
build/cli:
	...
	@GOOS=${GOOS_DARWIN} GOARCH=${GOARCH_AMD} go build -o ${BIN_DIR}enva/${GOOS_DARWIN}/${GOARCH_AMD}/${BIN_NAME} \
		-ldflags '-X github.com/maru44/enva/enva/commands.apiUrl=${CLI_API_URL} -X github.com/maru44/enva/enva/commands.frontUrl=${FRONT_PROTOCOL}${FRONT_HOST}${FRONT_PORT} -X github.com/maru44/enva/enva/commands.envaSettingsFile=${SETTINGS_FILE_NAME}' ${ENVA_MAIN_FILE}
	@echo 'Finish ${GOOS_DARWIN}!!'

	@echo 'Start ${GOOS_LINUX}'
	@GOOS=${GOOS_LINUX} GOARCH=${GOARCH_AMD} go build -o ${BIN_DIR}enva/${GOOS_LINUX}/${GOARCH_AMD}/${BIN_NAME} \
		-ldflags '-X github.com/maru44/enva/enva/commands.apiUrl=${CLI_API_URL} -X github.com/maru44/enva/enva/commands.frontUrl=${FRONT_PROTOCOL}${FRONT_HOST}${FRONT_PORT} -X github.com/maru44/enva/enva/commands.envaSettingsFile=${SETTINGS_FILE_NAME}' ${ENVA_MAIN_FILE}
	@GOOS=${GOOS_LINUX} GOARCH=${GOARCH_386} go build -o ${BIN_DIR}enva/${GOOS_LINUX}/${GOARCH_386}/${BIN_NAME} \
		-ldflags '-X github.com/maru44/enva/enva/commands.apiUrl=${CLI_API_URL} -X github.com/maru44/enva/enva/commands.frontUrl=${FRONT_PROTOCOL}${FRONT_HOST}${FRONT_PORT} -X github.com/maru44/enva/enva/commands.envaSettingsFile=${SETTINGS_FILE_NAME}' ${ENVA_MAIN_FILE}
	@echo 'Finish ${GOOS_LINUX}!!'

	@echo 'Start ${GOOS_WINDOWS}'
	@GOOS=${GOOS_WINDOWS} GOARCH=${GOARCH_AMD} go build -o ${BIN_DIR}enva/${GOOS_WINDOWS}/${GOARCH_AMD}/${BIN_NAME} \
		-ldflags '-X github.com/maru44/enva/enva/commands.apiUrl=${CLI_API_URL} -X github.com/maru44/enva/enva/commands.frontUrl=${FRONT_PROTOCOL}${FRONT_HOST}${FRONT_PORT} -X github.com/maru44/enva/enva/commands.envaSettingsFile=${SETTINGS_FILE_NAME}' ${ENVA_MAIN_FILE}
	@GOOS=${GOOS_WINDOWS} GOARCH=${GOARCH_386} go build -o ${BIN_DIR}enva/${GOOS_WINDOWS}/${GOARCH_386}/${BIN_NAME} \
		-ldflags '-X github.com/maru44/enva/enva/commands.apiUrl=${CLI_API_URL} -X github.com/maru44/enva/enva/commands.frontUrl=${FRONT_PROTOCOL}${FRONT_HOST}${FRONT_PORT} -X github.com/maru44/enva/enva/commands.envaSettingsFile=${SETTINGS_FILE_NAME}' ${ENVA_MAIN_FILE}
