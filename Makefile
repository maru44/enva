...
compress:
	...
	@go run ./version/internal/main.go tar/json ${VERSION} ${GOOS_DARWIN} ${GOARCH_AMD}
	...
	@go run ./version/internal/main.go tar/json ${VERSION} ${GOOS_LINUX} ${GOARCH_AMD}
	@go run ./version/internal/main.go tar/json ${VERSION} ${GOOS_LINUX} ${GOARCH_386}
	...
	@go run ./version/internal/main.go tar/json ${VERSION} ${GOOS_WINDOWS} ${GOARCH_AMD}
	@go run ./version/internal/main.go tar/json ${VERSION} ${GOOS_WINDOWS} ${GOARCH_386}
...
explain/json:
	@go run ./version/internal/main.go explain/json
